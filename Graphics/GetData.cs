...
namespace Graphics
{
    internal class GetData
    {
        ...
        {
            string content;
            using (FileStream fileStream = new FileStream("C:\\Users\\Omer Cohen\\Documents\\Programming\\Actual sandbox sln\\log.txt", FileMode.Open, FileAccess.Read, FileShare.ReadWrite))
            {
